    ...
    Sized + Clone + Copy + Send + Sync + Debug + Seal + arch_types::ArchTypes + 'static
{
    ...
    #[doc = "Compact the bytes selected by `mask` into consecutive low lanes.\n\nLanes above the number of selected bytes retain the corresponding values from `merge`. Mask bits above the vector's lane count are ignored."]
    #[inline(always)]
    ...
    #[doc = "Expand consecutive low bytes from `values` into the lanes selected by `mask`.\n\nUnselected lanes retain the corresponding values from `merge`. Mask bits above the vector's lane count are ignored."]
    #[inline(always)]
    ...
    #[doc = "Load consecutive bytes from `source` into the lanes selected by `mask`.\n\nThe first selected-lane-count bytes are consumed. Unselected lanes retain the corresponding values from `merge`. Mask bits above the vector's lane count are ignored."]
    #[inline(always)]
